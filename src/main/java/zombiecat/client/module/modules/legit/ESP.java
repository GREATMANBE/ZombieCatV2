...
public class ESP extends Module {
      ...
      for (Entity entity : entities) {
         if (entity != thePlayer) {
            ...
            if (entity instanceof EntityZombie) {
               ...
               // Print debug info about headgear
               debugPrintHeadgear(living);
   ...
   private void debugPrintHeadgear(EntityLivingBase entity) {
      ItemStack helmet = entity.getEquipmentInSlot(4);
      if (helmet == null || helmet.getItem() == null) {
         System.out.println(entity.getName() + " is wearing no helmet.");
      } else {
         String itemName = helmet.getDisplayName();
         System.out.println(entity.getName() + " is wearing on head: " + itemName);
      }
   }
