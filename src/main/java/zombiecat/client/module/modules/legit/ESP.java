      ...
      for (Entity entity : entities) {
         if (entity != thePlayer) {
            ...
            if (entity instanceof EntityZombie) {
               ...
               if (leggings != null && leggings.hasTagCompound() && leggings.getTagCompound().hasKey("display", 10)) {
                   int leggingsColor = leggings.getTagCompound().getCompoundTag("display").getInteger("color");
                   System.out.println("Leggings color (hex): " + Integer.toHexString(leggingsColor));
               }
               
               // Boots (slot 1)
               ItemStack boots = living.getEquipmentInSlot(1);
               if (boots != null && boots.hasTagCompound() && boots.getTagCompound().hasKey("display", 10)) {
                   int bootsColor = boots.getTagCompound().getCompoundTag("display").getInteger("color");
                   System.out.println("Boots color (hex): " + Integer.toHexString(bootsColor));
               }
